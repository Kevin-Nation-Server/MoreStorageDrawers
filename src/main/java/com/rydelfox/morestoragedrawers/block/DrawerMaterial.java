...
public enum DrawerMaterial implements StringRepresentable {
    ...
    MINECRAFT_LIGHT_GRAY_CONCRETE(ID.MINECRAFT, "light_gray_concrete", "Light Gray Concrete", 102, "light_gray_concrete", "light_gray_concrete"),
    MINECRAFT_GRAY_CONCRETE(ID.MINECRAFT, "gray_concrete", "Gray Concrete", 103, "gray_concrete", "gray_concrete"),
    MINECRAFT_BLACK_CONCRETE(ID.MINECRAFT, "black_concrete", "Black Concrete", 104, "black_concrete", "black_concrete"),
    MINECRAFT_BROWN_CONCRETE(ID.MINECRAFT, "brown_concrete", "Brown Concrete", 105, "brown_concrete", "brown_concrete"),
    MINECRAFT_RED_CONCRETE(ID.MINECRAFT, "red_concrete", "Red Concrete", 106, "red_concrete", "red_concrete"),
    MINECRAFT_ORANGE_CONCRETE(ID.MINECRAFT, "orange_concrete", "Orange Concrete", 107, "orange_concrete", "orange_concrete"),
    MINECRAFT_YELLOW_CONCRETE(ID.MINECRAFT, "yellow_concrete", "Yellow Concrete", 108, "yellow_concrete", "yellow_concrete"),
    MINECRAFT_LIME_CONCRETE(ID.MINECRAFT, "lime_concrete", "Lime Concrete", 109, "lime_concrete", "lime_concrete"),
    MINECRAFT_GREEN_CONCRETE(ID.MINECRAFT, "green_concrete", "Green Concrete", 110, "green_concrete", "green_concrete"),
    MINECRAFT_CYAN_CONCRETE(ID.MINECRAFT, "cyan_concrete", "Cyan Concrete", 111, "cyan_concrete", "cyan_concrete"),
    MINECRAFT_LIGHT_BLUE_CONCRETE(ID.MINECRAFT, "light_blue_concrete", "Light Blue Concrete", 112, "light_blue_concrete", "light_blue_concrete"),
    MINECRAFT_BLUE_CONCRETE(ID.MINECRAFT, "blue_concrete", "Blue Concrete", 113, "blue_concrete", "blue_concrete"),
    MINECRAFT_PURPLE_CONCRETE(ID.MINECRAFT, "purple_concrete", "Purple Concrete", 114, "purple_concrete", "purple_concrete"),
    MINECRAFT_MAGENTA_CONCRETE(ID.MINECRAFT, "magenta_concrete", "Magenta Concrete", 115, "magenta_concrete", "magenta_concrete"),
    MINECRAFT_PINK_CONCRETE(ID.MINECRAFT, "pink_concrete", "Pink Concrete", 116, "pink_concrete", "pink_concrete"),

    MINECRAFT_TERRACOTTA(ID.MINECRAFT, "terracotta", "Terracotta", 117, "terracotta", "terracotta"),
    ...
    TWILIGHTFOREST_TOWER(ID.TWILIGHTFOREST, "tower", "Towerwood", 11, "towerwood", "cacked_towerwood", 25, 20, 0),
    ...
    TWILIGHTFOREST_TRANS(ID.TWILIGHTFOREST, "trans", "Transwood", 17, "transformation_planks", "transformation_slab"),
    TWILIGHTFOREST_MINE(ID.TWILIGHTFOREST, "mine", "Minewood", 18, "mining_planks", "mining_slab"),
    TWILIGHTFOREST_SORT(ID.TWILIGHTFOREST, "sort", "Sortingwood", 19, "sorting_planks", "sorting_slab"),
